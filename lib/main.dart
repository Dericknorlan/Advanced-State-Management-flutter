...
import 'package:global_state/global_state.dart';  // Import your global state manager package
                ...
                child: Padding(
                  ...
                  child: DottedBorder(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('Drop items here to reorder', style: TextStyle(fontSize: 16))),
                    ),
                  ),
                ),
              ),
